...
<form id="form1" class="layui-form" action="">
    <fieldset class="layui-elem-field">
        ...
        <table width="96%" align="center">
            ...
            <tr>
                ...
                <td nowrap="nowrap">
                    <input type="hidden" id="serviceid" name="serviceid" value="${tbService.serviceid}">
                    ...
                    <input id="title" name="title" class="layui-input" type="text" placeholder="请输入标题" autocomplete="off"
                           lay-verify="title" value="${tbService.title}">
                </td>
            </tr>
            <tr>
                <td nowrap="nowrap">标题概述:</td>
                <td nowrap="nowrap">
                    <textarea name="comments" placeholder="请输入内容" class="layui-textarea" lay-verify="comments">${tbService.comments}</textarea>
                </td>
            </tr>
            <tr>
                ...
                <td nowrap="nowrap">
                    ...
                    <input type="hidden" id="imgurl" name="imgurl" lay-verify="imgurl" value="${tbService.imgurl}"/>
                </td>
            </tr>
            <tr>
                <td nowrap="nowrap">已上传配图展示:</td>
                <td nowrap="nowrap">
                    <img id="picid" src="${pageContext.request.contextPath}${tbService.imgurl}" width="370" height="260" />
                </td>
    ...
    <fieldset class="layui-elem-field">
        ...
        <table width="96%" align="center">
            ...
            <tr>
                <td>
                    <textarea id="summernote" name="servicedetails" lay-verify="details">${tbService.details}</textarea>
                </td>
            </tr>
            <tr>
                <td nowrap="nowrap">
...
//            data.field.servicedetails = $('#summernote').summernote('code').replace(/\"/g,"'");
//            alert(JSON.stringify(data.field));
            $.ajax({
                data : data.field,
                type : "POST",
                url : "${pageContext.request.contextPath}/eyas/admin/addServices", //图片上传出来的url，返回的是图片上传后的路径，http格式
                dataType : "json",
